...
int get hashCode {
  final _this = this as TransactionCandidate;
  return Object.hash(runtimeType,_this.fingerprint,_this.amount,_this.type,_this.method,_this.confidence,_this.confidenceTier,_this.occurredAt,_this.parserVersion,_this.sourcePackage,_this.merchant,_this.counterparty,_this.referenceId,_this.maskedAccount,_this.likelySalary,_this.categoryHint);
}

@override
String toString() {
  final _this = this as TransactionCandidate;
  return 'TransactionCandidate(fingerprint: ${_this.fingerprint}, amount: ${_this.amount}, type: ${_this.type}, method: ${_this.method}, confidence: ${_this.confidence}, confidenceTier: ${_this.confidenceTier}, occurredAt: ${_this.occurredAt}, parserVersion: ${_this.parserVersion}, sourcePackage: ${_this.sourcePackage}, merchant: ${_this.merchant}, counterparty: ${_this.counterparty}, referenceId: ${_this.referenceId}, maskedAccount: ${_this.maskedAccount}, likelySalary: ${_this.likelySalary}, categoryHint: ${_this.categoryHint})';
}
...
@useResult
$Res call({
 String fingerprint, int amount, DetectionTransactionType type, PaymentMethod method, double confidence, ConfidenceTier confidenceTier, DateTime occurredAt, String parserVersion, String sourcePackage, String? merchant, String? counterparty, String? referenceId, String? maskedAccount, bool likelySalary, String? categoryHint
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String fingerprint,  int amount,  DetectionTransactionType type,  PaymentMethod method,  double confidence,  ConfidenceTier confidenceTier,  DateTime occurredAt,  String parserVersion,  String sourcePackage,  String? merchant,  String? counterparty,  String? referenceId,  String? maskedAccount,  bool likelySalary,  String? categoryHint)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionCandidate() when $default != null:
return $default(_that.fingerprint,_that.amount,_that.type,_that.method,_that.confidence,_that.confidenceTier,_that.occurredAt,_that.parserVersion,_that.sourcePackage,_that.merchant,_that.counterparty,_that.referenceId,_that.maskedAccount,_that.likelySalary,_that.categoryHint);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String fingerprint,  int amount,  DetectionTransactionType type,  PaymentMethod method,  double confidence,  ConfidenceTier confidenceTier,  DateTime occurredAt,  String parserVersion,  String sourcePackage,  String? merchant,  String? counterparty,  String? referenceId,  String? maskedAccount,  bool likelySalary,  String? categoryHint)  $default,) {final _that = this;
switch (_that) {
case _TransactionCandidate():
return $default(_that.fingerprint,_that.amount,_that.type,_that.method,_that.confidence,_that.confidenceTier,_that.occurredAt,_that.parserVersion,_that.sourcePackage,_that.merchant,_that.counterparty,_that.referenceId,_that.maskedAccount,_that.likelySalary,_that.categoryHint);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode {
    return Object.hash(runtimeType,fingerprint,amount,type,method,confidence,confidenceTier,occurredAt,parserVersion,sourcePackage,merchant,counterparty,referenceId,maskedAccount,likelySalary,categoryHint);
}
