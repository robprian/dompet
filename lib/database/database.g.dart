...
class $TransactionDetectionsTable extends TransactionDetections
  ...
  @override
  late final GeneratedColumnWithTypeConverter<DetectionTransactionType, String>
  type =
      GeneratedColumn<String>(
        'type',
        aliasedName,
  ...
  @override
  late final GeneratedColumnWithTypeConverter<ConfidenceTier, String>
  confidenceTier =
      GeneratedColumn<String>(
        'confidence_tier',
        aliasedName,
  ...
  TransactionDetection map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TransactionDetection(
      ...
      confidenceTier: $TransactionDetectionsTable.$converterconfidenceTier
          .fromSql(
            attachedDatabase.typeMapping.read(
              DriftSqlType.string,
  ...
  static JsonTypeConverter2<DetectionTransactionType, String, String>
  $convertertype = const EnumNameConverter(DetectionTransactionType.values);
  static JsonTypeConverter2<ConfidenceTier, String, String>
  $converterconfidenceTier = const EnumNameConverter(ConfidenceTier.values);
  static JsonTypeConverter2<PaymentMethod, String, String> $convertermethod =
      const EnumNameConverter(PaymentMethod.values);
  static JsonTypeConverter2<DetectionStatus, String, String> $converterstatus =
      const EnumNameConverter(DetectionStatus.values);
}

class TransactionDetection extends DataClass
    implements Insertable<TransactionDetection> {
  final String id;
  ...
  factory TransactionDetection.fromJson(
    ...
    return TransactionDetection(
      ...
      confidenceTier: $TransactionDetectionsTable.$converterconfidenceTier
          .fromJson(serializer.fromJson<String>(json['confidenceTier'])),
...
class TransactionDetectionsCompanion
    extends UpdateCompanion<TransactionDetection> {
  final Value<String> id;
...
class SalaryProfile extends DataClass implements Insertable<SalaryProfile> {
  ...
  SalaryProfilesCompanion toCompanion(bool nullToAbsent) {
    return SalaryProfilesCompanion(
      ...
      sourcePackage: sourcePackage == null && nullToAbsent
          ? const Value.absent()
          : Value(sourcePackage),
      lastDetectedAt: lastDetectedAt == null && nullToAbsent
          ? const Value.absent()
  ...
  SalaryProfile copyWith({
    ...
    sourcePackage: sourcePackage.present
        ? sourcePackage.value
        : this.sourcePackage,
    lastDetectedAt: lastDetectedAt.present
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $TransactionDetectionsTable transactionDetections =
      $TransactionDetectionsTable(this);
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<TransactionDetection>
  >
  _transactionDetectionsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.transactionDetections,
        aliasName: 'categories__id__transaction_detections__category_id',
      );

  $$TransactionDetectionsTableProcessedTableManager
  get transactionDetectionsRefs {
...
class $$CategoriesTableFilterComposer
  ...
  Expression<bool> transactionDetectionsRefs(
    ...
    final $$TransactionDetectionsTableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
...
class $$CategoriesTableAnnotationComposer
  ...
  Expression<T> transactionDetectionsRefs<T extends Object>(
    ...
    final $$TransactionDetectionsTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.transactionDetections,
                    ...
                    return [
                      ...
                      if (transactionDetectionsRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$CategoriesTableReferences
                              ._transactionDetectionsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$CategoriesTableReferences(
                                db,
                                table,
...
typedef $$GoalsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool accountId})
    >;
typedef $$TransactionDetectionsTableCreateCompanionBuilder =
    TransactionDetectionsCompanion Function({
      Value<String> id,
      required String sourcePackage,
      required DetectionTransactionType type,
      required int amount,
...
typedef $$TransactionDetectionsTableUpdateCompanionBuilder =
    TransactionDetectionsCompanion Function({
      Value<String> id,
      Value<String> sourcePackage,
      Value<DetectionTransactionType> type,
...
final class $$TransactionDetectionsTableReferences
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) => db.categories
      .createAlias('transaction_detections__category_id__categories__id');
  ...
  static $AccountsTable _accountIdTable(_$AppDatabase db) => db.accounts
      .createAlias('transaction_detections__account_id__accounts__id');
...
class $$TransactionDetectionsTableFilterComposer
    extends Composer<_$AppDatabase, $TransactionDetectionsTable> {
  $$TransactionDetectionsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnWithTypeConverterFilters<ConfidenceTier, ConfidenceTier, String>
  get confidenceTier => $composableBuilder(
  ...
  ColumnWithTypeConverterFilters<DetectionStatus, DetectionStatus, String>
...
class $$TransactionDetectionsTableOrderingComposer
    extends Composer<_$AppDatabase, $TransactionDetectionsTable> {
...
class $$TransactionDetectionsTableAnnotationComposer
    extends Composer<_$AppDatabase, $TransactionDetectionsTable> {
  $$TransactionDetectionsTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  GeneratedColumnWithTypeConverter<ConfidenceTier, String> get confidenceTier =>
      $composableBuilder(
        column: $table.confidenceTier,
        builder: (column) => column,
      );
                  ...
                  >(state) {
                    if (categoryId) {
                      state = state.withJoin(
                        currentTable: table,
                        currentColumn: table.categoryId,
                        referencedTable: $$TransactionDetectionsTableReferences
                            ._categoryIdTable(db),
                        referencedColumn: $$TransactionDetectionsTableReferences
                            ._categoryIdTable(db)
                            .id,
                      ) as T;
                    }
...
final class $$MerchantCategoryRulesTableReferences
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) => db.categories
      .createAlias('merchant_category_rules__category_id__categories__id');
